...
public:
    template <std::size_t>
    friend decltype(auto) get(Bar&) noexcept;

    template <std::size_t>
    friend decltype(auto) get(Bar const&) noexcept;
...
template <>
decltype(auto) get<0>(Bar& b) noexcept
{
    return b.i_;
}
template <>
decltype(auto) get<1>(Bar& b) noexcept
{
    return b.d_;
}
template <>
decltype(auto) get<2>(Bar& b) noexcept
{
    return b.str_;
}

template <>
decltype(auto) get<0>(Bar const& b) noexcept
{
    return b.i_;
}
template <>
decltype(auto) get<1>(Bar const& b) noexcept
{
    return b.d_;
}
template <>
decltype(auto) get<2>(Bar const& b) noexcept
{
    return b.str_;
}
...
decltype(auto) get<1>(Bar&& b) noexcept
{
    return std::move(b.d_);
}
template <>
decltype(auto) get<2>(Bar&& b) noexcept
{
    return std::move(b.str_);
}
